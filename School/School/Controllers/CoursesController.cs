    ...
    public class CoursesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Courses != null ? 
                          ...
                          Problem("Entity set 'MvcSchoolContext.Courses'  is null.");
        }
        public async Task<IActionResult> GetCoursesByStudent(int? Id)
        {
            return View("Index", await _context.Courses
                .Where(c => c.students.Any(s => s.Id.Equals(Id))).ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcSchoolContext.Courses'  is null.");
            }
            var course = await _context.Courses.FindAsync(id);
            if (course != null)
            {
